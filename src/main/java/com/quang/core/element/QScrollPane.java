...
public class QScrollPane extends WidgetGroup {
    ...
    public QScrollPane (@Null Actor actor) {
        this(actor, new ScrollPane.ScrollPaneStyle());
    }

    /** @param actor May be null. */
    public QScrollPane (@Null Actor actor, Skin skin) {
        this(actor, skin.get(ScrollPane.ScrollPaneStyle.class));
    }

    /** @param actor May be null. */
    public QScrollPane (@Null Actor actor, Skin skin, String styleName) {
        this(actor, skin.get(styleName, ScrollPane.ScrollPaneStyle.class));
    }

    /** @param actor May be null. */
    public QScrollPane (@Null Actor actor, ScrollPane.ScrollPaneStyle style) {
    ...
    protected void addCaptureListener () {
        addCaptureListener(new InputListener() {
            ...
            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (getStage() != null) getStage().setScrollFocus(QScrollPane.this);
        ...
        return new ActorGestureListener() {
            ...
            public void fling (InputEvent event, float x, float y, int button) {
                ...
                if (velocityX != 0 || velocityY != 0) {
                    ...
                    QScrollPane.this.fling(flingTime, velocityX, velocityY);
                }
            }
